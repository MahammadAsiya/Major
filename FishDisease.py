...
main = tkinter.Tk()
main.title("PREDICTING  FISH DISEASES EARLY USING MACHINE LEARING AND WATER QUALITY ASSESSMENT") #designing main screen
...
font = ('times', 16, 'bold')
title = Label(main, text='PREDICTING  FISH DISEASES EARLY USING MACHINE LEARING AND WATER QUALITY ASSESSMENT')
